	...
	<section class="content content-wrapper">
		...
		<div class="col-xs-6" >
			  <div class="box" id="body">
				   ...
				   <form class="form-horizontal" action="/base/binding/save" method="post">
              <div class="box-body col-xs-12">
                <div class="form-group">
                  <label for="dbName" class="col-sm-2 control-label">数据库名称</label>

                  <div class="col-sm-10">
                    <input type="text" name="dbName" class="form-control" id="dbName" placeholder="dbName">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
	                    <input type="text" name="dbClass"  class="form-control" id="dbClass" placeholder="className">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
